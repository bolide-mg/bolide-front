...
const Section = ({
    ...
    <div className={`w-4/5 bg-light rounded-xl flex flex-col items-center ${reverted ? "md:flex-row-reverse" : "md:flex-row"}`}>
        {
            image ?
            <Image
            width={300}
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-10 w-full items-center pb-8">
                ...
                <Section
                    text={<>
                        <p>Avec notre large sélection de véhicules neufs et d`occasion, vous êtes sûr de trouver
                            la
                    ...
                    text={<>
                        <ul className="list-decimal">
                            ...
                            <li><p className="font-semibold">Qualité et Fiabilité</p>
                                Chaque voiture passe par une inspection rigoureuse avant d`être mise en vente,
                                vous garantissant ainsi des véhicules fiables et en parfait état.
                            </li>
                        </ul>
                    </>}
                />
                <Section
                    text={<>
                        ...
                        <br/>
                        <p>Nous sommes passionnée par l'automobile et dédiée à fournir des véhicules de qualité
                            à des prix compétitifs. Notre équipe est là pour vous conseiller et vous accompagner
                            tout au long de votre achat.</p>
                        <br/>
                        <p>Notre mission est de rendre l'achat de voiture aussi simple et agréable que possible,
                            en mettant l'accent sur la transparence et la satisfaction du client.</p>
                    </>}
                    image="https://th.bing.com/th/id/R.a701b4055fcaa63eba58a5a2205dcba8?rik=XzKpQj1V5SJJCA&riu=http%3a%2f%2fwww.itcjewelry.com%2fimg%2fillustration-1.png&ehk=9YYEaRBknefzGSHvi6JX1YfHQVgb%2fYC1OdUk0UucjKE%3d&risl=&pid=ImgRaw&r=0"
                />
            </div>
