...
const Home: NextPage = () =>
    <>
        <nav className="px-32 py-2 flex justify-between align-center bg-dark bg-opacity-50 backdrop-blur overflow-hidden fixed w-full shadow-2xl z-20">
            <Link href="/"><span className="text-3xl font-bold text-light">bolide.mg</span></Link>
            <Link href="/admin"><button className="button-primary">Se connecter</button></Link>
        </nav>
        <main className="px-32 py-8 font-medium">
            <div id="hero" className="h-lvh flex flex-col items-center justify-center">
                <Image src={heroImage} priority width={2400} height={900} alt="2024-AMG-CLE-COUPE" placeholder="blur" className="-z-10 h-screen absolute overflow-hidden aspect-square top-0" />
                <div className="drop-shadow text-light flex flex-col px-12 gap-6">
                    ...
                    <div className="flex flex-row gap-4">
                        <Link href="/"><button className="button-primary">Prendre rendez-vous</button></Link>
                        <Link href="/admin"><button className="button-primary">Se connecter</button></Link>
                    </div>
                </div>
            </div>
            <div id="catalogue" className="h-screen py-12 flex flex-col gap-8 text-center">
